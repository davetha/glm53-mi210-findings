...
def _fold_seqlen_indptr(indptr, fold_factor):
    ...
    # Assigning a Python scalar into a CUDA tensor makes PyTorch stage an
    # unpinned host->device copy, which is illegal inside a cudagraph
    # capture. zero_() on the same element is a pure device-side fill.
    out[:1].zero_()
